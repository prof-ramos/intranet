...
| Directory      | Purpose                                                                                                                                                                                    |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `adr/`         | Architecture Decision Records covering auth, DB, RLS, PII, notifications, kanban, LGPD (incl. export/acesso — ADR 019), go-live, rollback, incident ownership, DMS/Papra, and environments |
