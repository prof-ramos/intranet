...
No caso de documento a ser impresso, exclusivamente quando o signatário for o Presidente da República, Ministro de Estado ou a autoridade máxima de autarquia, será utilizado timbre em relevo branco, nos termos do disposto no Decreto no 80.739, de 14 de novembro de 1977.
...
b) espaçamento entre lines: simples;
c) parágrafos:
...
c) espaçamento entre lines: simples;
...
k) arquivamento: dentro do possível, todos os documentos elaborados devem ter o arquivo de texto preservado para consulta posterior ou aproveitamento de trechos para casos análogos.
l) nome do arquivo: tipo do documento + número do documento + ano do documento (com 4 dígitos) + palavras-chaves do conteúdo
