...
| WebMCP/MCP          | WebMCP de navegador registra ferramentas no `document.modelContext`; sem MCP externo. Catálogo: [webmcp.md](./webmcp.md) | Criar adaptador MCP fino sobre a API, com tools P0/P1 e actor automatizado distinguível                                                      | `src/lib/webmcp/catalog.ts`, `src/lib/webmcp/register.ts`, `src/lib/webmcp/build-tools.ts` |
