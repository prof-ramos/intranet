...
ALTER TYPE "public"."notification_entity_type" ADD VALUE 'oficio';--> statement-breakpoint
ALTER TYPE "public"."notification_type" ADD VALUE 'oficio.status_changed';--> statement-breakpoint
...
ALTER TABLE "oficios" ADD COLUMN "recipient_address" text;--> statement-breakpoint
ALTER TABLE "oficios" ADD COLUMN "recipient_city" text;--> statement-breakpoint
ALTER TABLE "oficios" ADD COLUMN "recipient_zip" text;--> statement-breakpoint
