...
- Worktrees aninhados tambem contam: se `.claude/worktrees/*` or `.worktrees/*` aparecer como dirty no repo principal, entre no worktree correspondente e faca commit/stash la dentro. Nao resolva isso apagando ou revertendo alteracoes sem confirmar a origem.
