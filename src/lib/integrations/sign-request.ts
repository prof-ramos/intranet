...
import { INTEGRATION_HEADER_NAMES, type IntegrationSignatureInput } from '@/lib/integrations/types';

/**
 * Build a canonical signature payload for integration request signing.
 */
...
/**
 * Sign an integration request using HMAC-SHA256.
 */
...
/**
 * Build the full set of authentication headers for an outbound integration request.
 */
