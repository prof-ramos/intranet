...
| `system-users.ts` | System-user identity helpers for audit and automation                                  |
...
| `associates/`     | Official management plus identity reconciliation — lgpd, profile, repository, search and service                 |
| `audit/`          | Audit log queries and service                                                                                    |
| `auth/`           | Self-hosted auth, password reset, authorization and sessions (see `auth/AGENTS.md`)                              |
| `cache/`          | Cache helpers                                                                                                    |
| `cron/`           | Cron utilities                                                                                                   |
...
| `webmcp/`         | Tools WebMCP da Secretaria (`document.modelContext`, catálogo por role/rota). Ver `docs/webmcp.md`.              |
