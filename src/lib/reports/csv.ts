...
// ⚡ Bolt: Cache Intl instances to avoid expensive object creation on every cell format
const csvDateFormatter = new Intl.DateTimeFormat('pt-BR', { day: '2-digit', month: '2-digit', year: 'numeric' });
