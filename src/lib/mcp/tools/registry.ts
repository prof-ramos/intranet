...
const sensitiveAssociateIdSchema = associateIdSchema.extend({
  includeSensitive: z.literal(true),
});
...
export const CADASTRO_READ_TOOLS: readonly ToolDef[] = [
  ...
  },
  {
    ...
    description:
      'Consulta um oficial por ID. Dados pessoais sensíveis exigem includeSensitive=true.',
  ...
  {
    name: 'official_list_health_agreements',
    title: 'Listar convênios de saúde do oficial',
    description:
      'Lista os convênios de saúde cadastrados de um oficial mediante includeSensitive=true.',
  ...
  },
  {
    ...
    title: 'Busca global',
    description:
      'Busca global por nome de oficial e título de atividade. Não aceita CPF nem SIAPE.',
    inputSchema: globalSearchSchema,
    annotations: READ_ONLY_ANNOTATIONS,
    allowedRoles: ALL_ROLES,
    execute: async (input, principal) => globalSearch(globalSearchSchema.parse(input), principal),
  },
];
