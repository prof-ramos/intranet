...
describe('database schema contract', () => {
  ...
  it('has all expected CHECK constraints for range validation', async () => {
    ...
    const expected = [
      ...
      'email_triagens:chk_email_triagens_confianca_validacao',
      'email_triagens:chk_email_triagens_confianca_validacao',
      'email_triagens:chk_email_triagens_juridico_validacao',
      'email_triagens:chk_email_triagens_juridico_validacao',
      'email_triagens:chk_email_triagens_prazo_com_evidencia',
      'email_triagens:chk_email_triagens_prazo_com_evidencia',
      'email_triagens:chk_email_triagens_prazo_data_conf',
      'email_triagens:chk_email_triagens_prazo_data_conf',
      'email_triagens:chk_email_triagens_risco_validacao',
      'email_triagens:chk_email_triagens_risco_validacao',
