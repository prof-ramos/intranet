...
const expectedColumns = {
  ...
  mailing_campaigns: [
    'id:int8:NO',
    'name:text:NO',
    'channel:mailing_channel:NO',
    'subject:text:YES',
    'template_body:text:NO',
    'status:mailing_campaign_status:NO',
    'filters:jsonb:NO',
    'recipient_count:int4:NO',
    'sent_count:int4:NO',
    'failed_count:int4:NO',
    'created_by:int8:YES',
  ...
  mailing_recipients: [
    ...
    'email_ciphertext:text:YES',
    'status:mailing_recipient_status:NO',
    'attempts:int4:NO',
    'last_error:text:YES',
...
const expectedEnums = {
  ...
  payment_origin: ['sigepe', 'itamaraty', 'comprovante', 'outros'],
...
const expectedIndexes = {
  activities: [
    ...
    'idx_activities_open_updated',
    'idx_activities_status',
    'idx_activities_status_due_date',
    'idx_activities_title_trgm',
  ],
  activity_comments: [
    'activity_comments_pkey',
    'idx_activity_comments_activity_created_at',
    'idx_activity_comments_activity_id_active',
  ],
  activity_label_assignments: ['activity_label_assignments_activity_id_label_id_pk'],
  activity_labels: [
    'activity_labels_pkey',
    'activity_labels_slug_unique',
    'idx_activity_labels_active',
  ],
  ...
  legal_consultations: [
    ...
    'idx_legal_consultations_internal_number_trgm',
  ...
  legal_notes: [
    ...
    'idx_legal_notes_entity_created',
    'legal_notes_pkey',
  ],
  legal_opinion_tags: [
  ...
  mailing_campaigns: [
    'idx_mailing_campaigns_created_by',
    'idx_mailing_campaigns_status_created_at',
    'mailing_campaigns_pkey',
  ],
  mailing_recipients: [
    'idx_mailing_recipients_campaign_associate',
    'idx_mailing_recipients_campaign_status',
    'idx_mailing_recipients_pending',
    'mailing_recipients_pkey',
  ],
  monthly_payments: [
    ...
    'idx_monthly_payments_year_month_origin',
