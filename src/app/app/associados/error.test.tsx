...
describe('src/app/app/associados/error.tsx', () => {
  ...
  it('renders the configured title, message and recovery button', () => {
    ...
    expect(screen.getByRole('heading', { name: 'Erro ao carregar oficiais' })).toBeDefined();
    expect(screen.getByText('Não foi possível carregar a lista de oficiais. Verifique sua conexão e tente novamente.')).toBeDefined();
