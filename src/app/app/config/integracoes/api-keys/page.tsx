  ...
  return (
    <main className="mx-auto w-full max-w-[1180px] px-5 py-7 sm:px-8 lg:px-10">
      ...
      <p className="mt-3 max-w-3xl text-sm leading-6 text-[rgba(13,31,60,0.65)]">
        Gerencie chaves de acesso para integrações externas. Cada chave possui escopos
        restritos e é exibida em texto claro somente no momento da criação ou rotação.
      </p>
                ...
                <div>
                  ...
                  <div className="mt-3 flex flex-wrap gap-1.5">
                    {key.scopes.map((scope) => (
                      <span
                        key={scope}
                        className="rounded-full bg-[rgba(13,31,60,0.06)] px-2.5 py-1 text-xs font-medium text-[#0d1f3c] font-mono"
                      >
