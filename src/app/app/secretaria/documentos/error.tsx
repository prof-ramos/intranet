...
const logger = createLogger('error-boundary:documentos');
...
export default function DocumentosError({
  ...
  useEffect(() => {
    logger.error('Documentos error boundary caught', { error: toSafeErrorLog(error) }, error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        <h1 className="text-2xl font-bold text-[#040920]">Erro ao carregar documentos</h1>
