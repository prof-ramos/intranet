  ...
  return (
    <div className="space-y-8">
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <DestinatarioSection register={register} errors={errors} />
        <InformacoesSection register={register} errors={errors} />
        <CorpoSection
          register={register}
          errors={errors}
          setValue={setValue}
    ...
    >
      ...
      <div>
        ...
        {errors.itamaratySector && (
          <p className="mt-1 text-xs" style={{ color: error }}>
            {errors.itamaratySector.message}
          </p>
        )}
      </div>
...
function CorpoSection({
  ...
  return (
    ...
    >
      ...
      {errors.bodyRichText && (
        <p className="mt-1 text-xs" style={{ color: error }}>
          {errors.bodyRichText.message}
        </p>
      )}
      {errors.bodyPlainText && (
        <p className="mt-1 text-xs" style={{ color: error }}>
          {errors.bodyPlainText.message}
        </p>
      )}
