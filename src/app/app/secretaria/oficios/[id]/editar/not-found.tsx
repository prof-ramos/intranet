...
export default function OficioNotFound() {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        <h1 className="text-2xl font-bold text-[#040920]">Ofício não encontrado</h1>
        <p className="max-w-md text-[#59677a]">
          O ofício solicitado não existe ou foi removido. Verifique o link ou volte para a lista.
        </p>
        <Link
