...
describe('src/app/app/secretaria/oficios/error.tsx', () => {
  ...
  it('renders the configured title, message and recovery button', () => {
    ...
    expect(screen.getByRole('heading', { name: 'Erro ao carregar ofícios' })).toBeDefined();
    expect(screen.getByText('Não foi possível carregar os ofícios. Verifique sua conexão e tente novamente.')).toBeDefined();
