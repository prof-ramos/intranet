...
const logger = createLogger('error-boundary:secretaria');
...
export default function SecretariaError({
  ...
  useEffect(() => {
    logger.error('Secretaria error boundary caught', { error: toSafeErrorLog(error) }, error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        <h1 className="text-2xl font-bold text-[#040920]">Erro ao carregar secretaria</h1>
        <p className="max-w-md text-[#59677a]">
          Não foi possível carregar a secretaria. Verifique sua conexão e tente novamente.
        </p>
