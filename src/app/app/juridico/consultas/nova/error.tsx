...
const logger = createLogger('juridico:consultas:nova:error');
...
export default function NovaConsultaError({
  ...
  useEffect(() => {
    logger.error('Nova consulta error boundary caught', { error: toSafeErrorLog(error) }, error);
  }, [error]);
    ...
    <div className="mx-auto flex min-h-[60vh] w-full max-w-[1180px] flex-col items-center justify-center px-5 py-7">
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        <p className="max-w-md text-[rgba(13,31,60,0.60)]">
          Não foi possível carregar o formulário de nova consulta. Verifique sua conexão e tente
          novamente.
        </p>
        {error.digest && (
