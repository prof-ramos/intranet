...
export default createErrorBoundary({
  ...
  message: 'Não foi possível carregar a política de privacidade. Verifique sua conexão e tente novamente.',
  logMessage: 'Privacidade error boundary caught',
  loggerName: 'error-boundary:privacidade',
  useFocusRing: true,
