...
describe('src/app/app/financeiro/mensalidades/error.tsx', () => {
  ...
  it('renders the configured title, message and recovery button', () => {
    ...
    expect(screen.getByRole('heading', { name: 'Erro ao carregar mensalidades' })).toBeDefined();
    expect(screen.getByText('Não foi possível carregar as mensalidades. Verifique sua conexão e tente novamente.')).toBeDefined();
