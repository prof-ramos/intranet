...
describe('src/app/app/financeiro/error.tsx', () => {
  ...
  it('renders the configured title, message and recovery button', () => {
    ...
    expect(screen.getByRole('heading', { name: 'Erro ao carregar financeiro' })).toBeDefined();
    expect(screen.getByText('Não foi possível carregar o painel financeiro. Verifique sua conexão e tente novamente.')).toBeDefined();
