...
const logger = createLogger('error-boundary:etiquetas');
...
export default function EtiquetasError({
  ...
  useEffect(() => {
    logger.error('Etiquetas error boundary caught', { error: toSafeErrorLog(error) }, error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        <h1 className="text-2xl font-bold text-[#040920]">Erro ao carregar etiquetas</h1>
        <p className="max-w-md text-[#59677a]">
          Não foi possível carregar a geração de etiquetas. Verifique sua conexão e tente novamente.
        </p>
