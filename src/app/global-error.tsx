...
const logger = createLogger('error-boundary:global');
...
export default function GlobalError({
  ...
  useEffect(() => {
    logger.error('Global error boundary caught', { error: toSafeErrorLog(error) });
  }, [error]);

  return (
    <html lang="pt-BR" data-theme="ASOF">
      <body className="flex min-h-screen flex-col items-center justify-center px-4 font-sans antialiased">
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <p className="max-w-md text-[#59677a]">
            Ocorreu um erro inesperado. Tente novamente ou entre em contato com o suporte se o
            problema persistir.
          </p>
