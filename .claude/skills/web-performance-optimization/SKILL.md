...
- **INP (Interaction to Next Paint):** 180ms ❌ (should be < 200ms)
...
**Problem:** Large JavaScript bundle (850KB) blocks main thread
...
**Symptoms:** Long Time to Interactive (TTI), high INP
**Solution:**
