...
def recommend_database_technology(requirements):
    ...
    recommendations = {
        ...
        'serverless_relational': {
            ...
            'technologies': {
                'Supabase': 'Serverless PostgreSQL, built-in auth, RLS, realtime subscriptions',
...
- **database-optimization** — Delegate PostgreSQL query tuning, EXPLAIN analysis, index optimization, and slow-query investigation.
